...
interface Props {
  ISM: Day;
  IEM: Day;
  setISM: React.Dispatch<React.SetStateAction<Day>>;
  setIEM: React.Dispatch<React.SetStateAction<Day>>;
  IntervStart: string | null;
  IntervEnd: string | null;
  setIntervStart: React.Dispatch<React.SetStateAction<string | null>>;
  setIntervEnd: React.Dispatch<React.SetStateAction<string | null>>;
  toggle: () => void;
}
...
const InterviewDate: React.FC<Props> = ({
  ISM,
  IEM,
  setIEM,
  setISM,
  ...
  const [selectedDate1, setSelectedDate1] = useState<Day>(ISM);
  const [selectedDate2, setSelectedDate2] = useState<Day>(IEM);
  ...
  const handleSave = () => {
    ...
    setIntervStart(formattedStartDate);
    setIntervEnd(formattedEndDate);
    setISM(selectedDate1);
    setIEM(selectedDate2);
    toggle();
  };

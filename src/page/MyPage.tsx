                  ...
                  {getAnnounce == false ? (
                    ...
                    <AnnounceCenter>
                      ...
                      <AnnounceBox opened={true}>
                        ...
                        <AnnounceContent>
                          상처를 치료해줄 사람 어디 없나 가만히 놔뒀다가
                          끊임없이 덧나
                          <br />
                          사랑도 사람도 너무나도 겁나 혼자인게 무서워 난
                          잊혀질까 두려워
                          <br />
                          ...
                          기도했었네
                          <br />
                          시위를 당기고 내 손을 떠나간 추억의 화살이 머나먼
                          과녁을 향해서 한없이 빠르게 날아가 내게로 돌아와
                          달라고 내 손을 붙잡아 달라고 부르고 불러도 한없이
                          소리쳐 대봐도 아무런 대답이 없는 널
                          <br />내 기억 속에서 너라는 사람의 존재를 완전히
                          지우려 끝없이 몸부림쳐 봐도 매일밤 꿈에서 그대가
                          나타나 흐르는 눈물을 닦아주는걸 나 어떡하라고 다
                          끄떡없다고 거짓말 하라고 더는 못 참겠다고 나도 아플 땐
                          아프다고 슬플땐 슬프다고 얼어 붙은 심장이 자꾸만
                          내게로 고자질해 정말로 끝이라고 정말로 괜찮다고 꾹
